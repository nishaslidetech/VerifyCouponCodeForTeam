@verify_5OFF_Coupon
Feature: verify the 5OFF coupon 
...
@individual
  ...
  @BusinessTeam
  Scenario: verify the 5OFF coupon for free accounts for BusinessTeam 
  
  When select Business Team option 
  ...
  @Education
  Scenario: verify the 5OFF coupon for free accounts for education
  When select Education option 
