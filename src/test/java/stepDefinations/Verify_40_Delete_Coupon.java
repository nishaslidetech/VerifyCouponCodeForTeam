...
public class Verify_40_Delete_Coupon extends BaseClass {
	...
	public void user_is_on_home_page_then_click_on_signup_button() throws Throwable {
		/*
		 * Thread.sleep(3000); ClearBrowserCache(); driver.get(AppURL);
		 * 
		 * log.info("It's opening the website URL"); ClearBrowserCache(); WebElement
		 * signup =
		 * wait.until(ExpectedConditions.elementToBeClickable(By.xpath(OR.getProperty(
		 * "Signup")))); signup.click(); Thread.sleep(3000);
		 */
	}
	...
	public void creates_a_new_ueser() {
		/*
		 * // signup the application commonPage.signUp();
		 */
	}
	...
	public void click_on_account_botton() {
		/*
		 * try { Thread.sleep(2000); WebElement account =
		 * driver.findElement(By.xpath("//a[contains(.,'My Account')]"));
		 * account.click(); Thread.sleep(3000); } catch (InterruptedException e) { //
	...
	public void click_on_delete_button() throws Throwable {
		/*
		 * try { commonPage.chatWindow(); WebElement Delete_Account = wait
		 * .until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@id='clicking']"
		 * ))); Thread.sleep(2000); Delete_Account.click(); Thread.sleep(3000); } catch
	...
	public void select_one_of_radio_button_and_clcik_on_delete_profile() throws Throwable {
		/*
		 * try { WebElement radio_button = wait
		 * .until(ExpectedConditions.elementToBeClickable(By.xpath(
		 * "//input[@value='option1']"))); Thread.sleep(4000); radio_button.click();
		 * Thread.sleep(1000);
		 * 
		 * WebElement delete_Profile = wait.until(
		 * ExpectedConditions.elementToBeClickable(By.
		 * xpath("//button[normalize-space()='Delete Profile']")));
		 * delete_Profile.click(); commonPage.chatWindow(); Thread.sleep(2000); } catch
		 * (InterruptedException e) { // TODO Auto-generated catch block
		 * e.printStackTrace(); }
		 */
	}
	...
	public void click_on_join_now_option() {
		/*
		 * try { WebElement joinNow = wait
		 * .until(ExpectedConditions.elementToBeClickable(By.xpath(OR.getProperty(
		 * "joinNow_Monthly")))); js.executeScript("arguments[0].scrollIntoView();",
		 * joinNow); joinNow.click(); Thread.sleep(7000); } catch (InterruptedException
		 * e) {
		 * 
		 * e.printStackTrace(); }
		 */
	...
	public void apply_the_discount_coupon_code() {
		 ...
		 * 
		 * // apply the coupon commonPage.applyDeleteDiscountCoupon();
		 */
	}
	...
	public void enter_username_and_password(String username, String password) throws InterruptedException {
		...
		/*
		 * Thread.sleep(4000); try { WebElement email = wait
		 * .until(ExpectedConditions.elementToBeClickable(By.xpath(OR.getProperty(
		 * "email-Address")))); email.sendKeys(username);
		 * 
		 * WebElement password_field = wait
		 * .until(ExpectedConditions.elementToBeClickable(By.xpath(OR.getProperty(
		 * "password")))); password_field.sendKeys(password); Thread.sleep(2000);
		 * WebElement login_btn =
		 * BaseClass.elementToBeClickable(By.xpath(OR.getProperty("login_Btn")));
		 * login_btn.click(); Thread.sleep(3000); if
		 * (!driver.findElements(By.xpath(OR.getProperty("logon_Pop-Up"))).isEmpty()) {
		 * WebElement approve = wait
		 * .until(ExpectedConditions.elementToBeClickable(By.xpath(OR.getProperty(
		 * "approve_Btn")))); approve.click(); } Thread.sleep(4000); } catch
	...
	public void click_on_Join_Now_option() throws Throwable {
		 ...
		 * WebElement account =
		 * driver.findElement(By.xpath("//a[contains(.,'My Account')]"));
		 * account.click(); Thread.sleep(3000); commonPage.chatWindow();
		 * 
		 * WebElement Delete_Account = wait
		 * .until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@id='clicking']"
		 * ))); Thread.sleep(2000); Delete_Account.click();
		 * 
		 ...
		 * ExpectedConditions.elementToBeClickable(By.
		 * xpath("//button[normalize-space()='Delete Profile']")));
		 * delete_Profile.click(); Thread.sleep(2000); commonPage.chatWindow();
		 * 
		 * commonPage.copyDeleteDiscountCoupon();
		 * 
		 ...
		 * .until(ExpectedConditions.elementToBeClickable(By.xpath(OR.getProperty(
		 * "joinNow_Monthly")))); js.executeScript("arguments[0].scrollIntoView();",
		 * joinNow); joinNow.click(); Thread.sleep(7000);
		 * 
